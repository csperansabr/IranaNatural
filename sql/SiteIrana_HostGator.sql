...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.banners
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.categorias
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.compras_insumos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.configuracoes
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.depoimentos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.fichas_tecnicas
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.imagens_produtos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.import_errors
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.import_history
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.insumos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.mov_insumos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.mov_produtos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.producoes
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.produtos
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.usuarios
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.vendas
...
-- Copiando estrutura para tabela ***REDACTED_DB_PROD***.vendas_itens
