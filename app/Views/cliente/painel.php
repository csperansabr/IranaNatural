        ...
        <div class="painel-grid">
            ...
            <aside class="painel-sidebar">
                ...
                <nav class="painel-nav">
                    ...
                    <a href="<?= APP_URL ?>/minha-conta/alterar-senha" class="painel-nav__link">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" width="18" height="18" aria-hidden="true"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                        Alterar Senha
                    </a>
